...
Here's a Google Drive link to a pretrained model with a 65% IoU and 90% binary accuracy on the test set: https://drive.google.com/file/d/1n_PauRKuqn-GyzAAkktixMVkCTseFXLN/view?usp=sharing.
